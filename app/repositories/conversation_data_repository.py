        ...
        if user_inputs.anonymous=="true" or user_inputs.section <= 11:  
            ...
            with open(file2,'a',newline ='',encoding='utf-8') as f:
                ...
                if user_inputs.ai_data != {}:
                    ...
                    "timestamp":str(datetime.now()),'section':(user_inputs.section) ,'response_type':response_type,'multi':multi,'q_heavy':str(session['heavy_q']),'ai_data':user_inputs.ai_data,
