...
class BotProcessingService:
    ...
    def process_user_input(self, conversation_input_data, _sentence_encoder):
        ...
        if ((conversation_input_data.section > 0) and (conversation_input_data.section <= 11)):
            ...
            user_inputs_data = user_inputs.UserInputs(conversation_input_data.anonymous, conversation_id, conversation_input_data.message, prepared_response, conversation_input_data.section, conversation_input_data.client_id,output_data.ai_data,output_data.response_type)
